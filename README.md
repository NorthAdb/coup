...
- **独立视觉**：入口 `/brass`，工业时代黄铜/羊皮纸主题，SVG 版图（实体版图地理精调坐标、石板建造地块、**每城一座剪影**——Stoke 瓶窑/Dudley 城堡/Coalbrookdale 高炉/Coventry 双塔教堂等九类原型、产业瓦片正反面外观与产业徽标、运河水系/铁路枕木、煤立方/铁锭/啤酒桶立体 token、罗盘与铭牌、纸纹暗角）+ 局内动效（落子弹入、翻面闪烁、可铺连线蚂蚁线、可建地点呼吸辉光、日志滑入；尊重 prefers-reduced-motion）+ 行动向导（自动推导合法目标与资源来源）、市场格价条与当前买/卖价、竖版手牌卡（标注可建产业）、中文日志。门户首页 `/` 选择游戏。
