...
57. As a 本地玩家, I want 任一座位作出公开决策后在座位旁出现约 3 秒的座位呼出气泡且后来者替换前者（质疑/放弃质疑会停满可读）, so that 我不必紧盯右侧对局记录也能跟上刚刚发生的选择。
...
- 座位呼出由表现层根据已生效公开决策生成：所有座位均可出现，约 3 秒气泡，新呼出替换旧呼出；质疑/放弃质疑在结果节拍中停满约 3 秒；不替代右侧权威对局记录。
